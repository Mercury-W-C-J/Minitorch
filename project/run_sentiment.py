...
class CNNSentimentKim(minitorch.Module):
    ...
    def __init__(
        ...
        self.filter = filter_sizes
        self.dropout = dropout
        self.conv1 = Conv1d(
            embedding_size, out_channels=feature_map_size, kernel_width=filter_sizes[0]
        )
        self.conv2 = Conv1d(
            embedding_size, out_channels=feature_map_size, kernel_width=filter_sizes[1]
        )
        self.conv3 = Conv1d(
            embedding_size, out_channels=feature_map_size, kernel_width=filter_sizes[2]
        )
